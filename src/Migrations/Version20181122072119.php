 ...
 */
final class Version20181122072119 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote ADD owner_id INT NOT NULL, DROP owner');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quote ADD owner VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, DROP owner_id');
    }
}
